@file:OptIn(InternalMsgPackApi::class, ExperimentalWasmJsInterop::class)
...
@Serializable
private class SimpleSampleClassWithNestedClass(
    var testString: String,
    var testInt: Int,
    var testBoolean: Boolean,
    var testNested: SimpleNestedClass,
    var secondNested: SimpleNestedClass? = null,
) {
    @Serializable
...
private external interface ExtSimpleNestedClass : JsAny {
    var testInt: Int?
}

private external interface ExtSimpleSampleClassWithNestedClass : JsAny {
    var testString: String
    var testInt: Int
    var testBoolean: Boolean
    var testNested: ExtSimpleNestedClass
    var secondNested: ExtSimpleNestedClass?
}
...
open class DeserializeBenchmarks {
    ...
    fun benchmarkKotlinxSerializationMsgpack() {
        ...
        SimpleSampleClassWithNestedClass.serializer().deserialize(decoder)
    }

    @Benchmark
    fun benchmarkMsgpackJs() {
        @Suppress("ktlint:standard:max-line-length") decodeMsgpack<ExtSimpleSampleClassWithNestedClass>(
